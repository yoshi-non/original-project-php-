...
if (isset($_POST['update_product'])) {
    ...
    $update_query = mysqli_query($conn, "UPDATE `products` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'") or die('query failed');
    ...
    <div class="container">
        <section>
            <form action="" method="post" class="add-product-form" enctype="multipart/form-data">
                ...
                <input type="file" name="p_image" class="box" accept=".png, .jpg, .jpeg" required />
        ...
        <section class="edit-form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="file" class="box" required name="update_p_image" accept=".png, .jpg, jpeg">
